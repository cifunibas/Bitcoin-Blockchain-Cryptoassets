...
\begin{frame}{Atomic Cross Chain Swaps}
	...
	\begin{minipage}{0.8\linewidth}
		...
		\begin{figure}[t]
			\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
				\draw[color=black] plot (0,1.5) node {\large{{\textbf{C-Chain}}}};
				\fill[highlight!40] (3,-0.4) -- (-2,-0.4) -- (-2,-.9) -- (-3,0) -- (-2,.9) -- 	(-2,0.4) -- (3, 0.4) -- (3,-0.4);
				\draw[color=black] plot (0,0) node {\large{1 \texttt{Coin}}};
			\end{tikzpicture}
		\end{figure}%
		\vspace{0.1cm}
		...
		\begin{figure}[t]
			\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
				\draw[color=black] plot (0,1.5) node {\large{{\textbf{T-Chain}}}};
				\fill[highlight!40] (-3,-0.4) -- (2,-0.4) -- (2,-.9) -- (3,0) -- (2,.9) -- 	(2,0.4) -- (-3, 0.4) -- (-3,-0.4);
				\draw[color=black] plot (0,0) node {\large{2 \texttt{Token}}};
			\end{tikzpicture}
		\end{figure}
	\end{minipage}%
	\begin{minipage}{0.1\linewidth}
...
\begin{frame}{Atomic Cross Chain Swaps}
	...
	\begin{figure}[t]
			...
			\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
				...
				\draw[color=black] plot (-0.6,-2.21)   node[right] {1 \texttt{Coin}};
				...
				\draw[color=black] plot (1.4,-2.25)   node[right] {Alice:};
				\draw[color=black] plot (3.3,-2.21)   node[right] {1 \texttt{Coin}};
				\draw[color=black] plot (1.8125,-3.1)   node {\small{$Sig_A$}};
				\draw[color=black] plot (2.6375,-3.1)   node {\includegraphics[width=0.5cm]{../assets/images/hashlock_symbol.png}};
				...
				\draw[color=black] plot (3.3,-4.21)   node[right] {1 \texttt{Coin}};
		...
		\begin{figure}[b]
			...
			\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
				...
				\filldraw[yshift=-0.05cm, xshift=0.1cm,color = highlight!25, thick, 	draw=highlight] (-2.6,-3.4) rectangle ++(0.825cm,0.7cm);
				\draw[color=black] plot (-2.5,-2.25) node[right] {Alice:};
				\draw[color=black] plot (-0.85,-2.21)   node[right] {2 \texttt{Token}};
				\draw[color=black] plot (-2.0875,-3.1)   node {\small{$Sig_A$}};
				...
				\draw[color=black] plot (1.4,-2.25)   node[right] {Bob:};
				\draw[color=black] plot (3.05,-2.21)   node[right] {2 \texttt{Token}};
				\draw[color=black] plot (1.8125,-3.1)   node {\small{$Sig_B$}};
				\draw[color=black] plot (2.6375,-3.1)   node {\includegraphics[width=0.5cm]{../assets/images/hashlock_symbol.png}};
				...
				\draw[color=black] plot (1.4,-4.25)   node[right] {Alice:};
				\draw[color=black] plot (3.05,-4.21)   node[right] {2 \texttt{Token}};
				\draw[color=black] plot (1.8125,-5.1)   node {\small{$Sig_A$}};
...
\begin{frame}{Payment Channels}
	\begin{itemize}
		...
		\item<3 -> The Bitcoin network has a scaling problem. Payment channels tackle this, by allowing transaction to be exchanged off-chain, while still benefiting from Bitcoins security and being incentive compatible.
		\item<4 -> The next video will cover this topic in depth.
	\end{itemize}
\end{frame}
