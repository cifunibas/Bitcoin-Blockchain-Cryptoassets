...
\begin{table}\scriptsize
	\newcolumntype{F}{>{\raggedright\arraybackslash}p{2.4cm}}
	\begin{tabular}{FFF}
		\includegraphics[width = 1.9cm]{../assets/images/team/MG_BW} &
		\includegraphics[width = 1.9cm]{../assets/images/team/MN_BW}
		& \includegraphics[width = 1.9cm]{../assets/images/team/KS_BW} \\
		Mitchell Goldberg & Matthias Nadler	& Katrin Schuler \\
...
\begin{table}\scriptsize
	\newcolumntype{F}{>{\raggedright\arraybackslash}p{2.4cm}}
	\begin{tabular}{FFF}
		\includegraphics[width = 1.9cm]{../assets/images/team/LG_BW}	 & \includegraphics[width = 1.9cm]{../assets/images/team/JR_BW} & \includegraphics[width = 1.9cm]{../assets/images/team/DT_BW} \\
		Lorenz Geering & Jakob Roth & Dario Thürkauf 
	\end{tabular}
\end{table}
