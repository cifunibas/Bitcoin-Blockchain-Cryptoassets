	...
	\begin{columns}[T]
		...
		\begin{column}{0.31\textwidth}
			...
			\begin{table}\small
				\begin{tabular}{c}
					Andreas Arnold\\
					\href{https://linkedin.com/in/lorenz-geering-770359a8/}{\faLinkedinSquare}\ \href{}{\faTwitterSquare}\\
					\vspace{0.5em}\\
					Jonas Ruchti\\
					\href{https://www.linkedin.com/in/andreas-arnold-170a20225/}{\faLinkedinSquare}\ \href{https://twitter.com/jonas_ruchti}{\faTwitterSquare}\\
				\end{tabular}
			\end{table}
		\end{column}
	\end{columns}
