...
\center
  \begin{tikzpicture}[domain=-6:6,scale=0.6]
    ...
    \draw[color=black] plot (0,3)    node[fill=highlight!15, thick, rounded corners=4pt,draw=highlight,below, rotate = 0] {Private Key};
         ...
         \draw[color=black] plot (0,-8.5)   node[fill=focus!15, thick, rounded corners=4pt, draw=focus, below, rotate = 0] {Flexibility};
         \draw[color=black] plot (-3,-8.5)   node[fill=focus!15, thick, rounded corners=4pt, draw=focus, below, rotate = 0] {Security};
         \draw[color=black] plot (3,-8.5)   node[fill=focus!15, thick, rounded corners=4pt, draw=focus, below, rotate = 0, minimum height=0.6cm] {Comfort};
