...
\begin{frame}{Oracles on Bitcoin}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item<4-> Agents each hold $\frac{m}{2}$ keys and m-1 oracles hold one key each.
...
\begin{frame}{Proof of Existence}
	...
	\begin{tikzpicture} 
		...
		\uncover<+->{\node (img5) at (img2) {\includegraphics[width = 10cm, frame]{../assets/images/google4.PNG}};}
...
\begin{frame}{Diplomas on the Blockchain}
	...
	\vspace{0.5cm}
	\begin{minipage}{\linewidth}
	\uncover<2 ->{\textbf{\large{Verification:}}
	\begin{columns}
		\begin{column}{0.3\textwidth}
			\centering
