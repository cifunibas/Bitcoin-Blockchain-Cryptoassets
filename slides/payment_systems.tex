...
\uncover<1->{Digital Cash: Proof of ownership
\begin{figure}[h]
	\center
...
\uncover<1->{\vspace{1 em}

Registry Types\\
\vspace{1 em}
\textbf{Implicit:} Verbal agreements, limited to tight-knit groups.\\
\textbf{Explicit:} Records in written or digital databases, no limits.}
...
\uncover<1->{\textbf{Examples of Closed Loop Systems}
 	\begin{itemize}
...
\uncover<1->{\textbf{Multiple relationships and rule sets lead to compounding of:}
 	\begin{itemize}
