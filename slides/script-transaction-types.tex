...
\begin{columns}
  \begin{column}[T]{0.5\textwidth}
    \justifying
    \texttt{scriptPubKey:} Unlocking condition of the output. Contains exact specifications about the conditions of a reference and the process of verification. \\ $\rightarrow$ Locking script 
  \end{column}
  \begin{column}[T]{0.5\textwidth}
    \justifying
    \texttt{scriptSig:}
    Can be seen as a kind of solution to the unlocking condition of the referenced output. \\ $\rightarrow$ Unlocking script
  \end{column}
\end{columns}
\end{frame}
%%%
