...
\begin{frame}{Issues}
	\centering
	%\includegraphics[width = 8cm]{../assetlib/images/earth.png}\\
	\begin{itemize}
		\item<2-> Inconvenience
		\item<3-> Undermines spontaneity of online communication
		\item<4-> Search for better solution continues
	\end{itemize}
\end{frame}
%%%
...
\begin{frame}{Asymmetric Cryptography}
	...
	\uncover<3->{
		\begin{figure}
			...
			%\caption{Source: \cite{rivest1978}}
		\end{figure}
	}
\end{frame}
%%%
