...
\begin{figure}
	...
	%years
	\draw[ultra thick] (0.66,0) node[below=3pt] {{\scriptsize 1982}} ;
	\draw[ultra thick] (2.66,0) node[above=3pt] {{\scriptsize 1988}} ;
	\draw[ultra thick] (4.11,0) node[below=3pt] {{\scriptsize 1997}} ;
	\draw[ultra thick] (5,0) node[above=3pt] {{\scriptsize 1998}} ;
	\draw[ultra thick] (7.33,0) node[below=3pt] {{\scriptsize 2005}} ;
	...
	\node[align=center] at (2.66,1) {{\scriptsize Tim May} \\{\scriptsize Crypto Manifesto}};
	
	\node[align=center] at (4.11,-1.2) {{\scriptsize Adam Back} \\{\scriptsize Hashcash}};
	
	\node[align=center] at (5,1) {{\scriptsize Wei Dai} \\{\scriptsize B-money}};
	
	\node[align=center] at (7.33,-1.2) {{\scriptsize Hal Finney} \\{\scriptsize Reusable Proofs of Work}};
	
	\node[align=center] at (7.33,0.7) {{\scriptsize Nick Szabo} \\{\scriptsize Bit Gold}};
