...
\begin{frame}{What Is Money?}
	...
	\begin{figure}
		\input{../assets/figures/barter.tex}
	\end{figure}
	\uncover<3->{$\rightarrow$ Generally accepted medium of exchange.}
\end{frame}
%%%
...
\begin{frame}{Dominant Medium of Exchange}
	...
	\begin{columns}[T]
		\begin{column}{0.5\textwidth}
			...
			\end{footnotesize}
			\begin{figure}
				\input{../assets/figures/acceptance.tex}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\input{../assets/figures/coordination.tex}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{Money Is Memory}
	Money is a primitive form of memory \cite{kocherlakotaMoney1998}.
		\begin{figure}
			\input{../assets/figures/memory.tex}
		\end{figure}
	\uncover<4->{$\rightarrow$ Larger groups require money because trust is limited.}
\end{frame}
%%%
...
\begin{frame}{Medium of Exchange}
	\begin{figure}
		\input{../assets/figures/medium.tex}
	\end{figure}
\end{frame}
%%%
...
\begin{frame}{Examples of Dominant Media of Exchange}
	\begin{figure}
		\input{../assets/figures/money_examples}	
	\end{figure}
\end{frame}
%%%
...
\begin{frame}{Store of Value}
	...
	\uncover<3->{
		\begin{figure}
			\input{../assets/figures/inflation.tex}
			\footnotesize{Data: FRED Economic Research}
		\end{figure}
	}
\end{frame}
%%%
...
\begin{frame}{The Properties of Money}	
	\begin{figure}
		\input{../assets/figures/properties.tex}	
	\end{figure}
\end{frame}
%%%
...
\begin{frame}{Different Types of Money}
	\begin{figure}
		\input{../assets/figures/types.tex}
	\end{figure}
	\vspace{1.em}
	\begin{table}[h]
		\begin{center}
