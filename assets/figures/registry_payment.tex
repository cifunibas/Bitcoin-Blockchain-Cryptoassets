...
% Intermediary
\node 			(intermediary) at (6,-2.5) {\includegraphics[width = 1.2 cm]{../assets/images/avatar.png}};


% Goods vs. Money flow	
	\draw[->, thick, dashed]	(payer.south) -- (intermediary.west) 
						node[midway, fill=white] {Payment order};
						
\draw[->, thick, dashed]	(intermediary.east) -- (payee.south) 
...
%	\draw[rounded corners=5pt, focus, very thick]	(C) rectangle (D) node [midway, focus] {C};
