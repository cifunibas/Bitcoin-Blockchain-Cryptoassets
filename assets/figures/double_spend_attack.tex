...
\filldraw[color=highlight, fill = highlight!20, thick] (L3) circle (6pt) node[right = 0.2cm, color=black]{\footnotesize{knows first tx}};

\uncover<2->{
\filldraw[color=focus, fill = focus!20, thick] (L4) circle (6pt) node[right = 0.2cm, color=black]{\footnotesize{knows attack tx}};
}