\begin{tikzpicture}[scale = 0.8]
	\begin{axis}[xmin=0, xmax=36,
        ...
        \only<7->{
        	\draw [fill = focus, draw = focus] (axis cs: 6, 1) circle (1pt) node[above, focus]{\scriptsize{$3G$}};
		...
		\only<14->{
			\draw [fill = focus, draw = focus] (axis cs: 6, 36) circle (1pt) node[below, focus]{\scriptsize{$10G$}};
