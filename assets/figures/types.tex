\begin{tikzpicture}[scale = 0.8]
	\begin{footnotesize}
		...
		\uncover<2->{\draw[dotted] (-1.9, 0) rectangle (1.9, 4) node[above = 1cm, midway] {\textbf{Credit money}};}
		\uncover<3->{\draw[dotted] (2.1, 0) rectangle (5.9, 4) node[above = 1cm, midway] {\textbf{Fiat money}};}
