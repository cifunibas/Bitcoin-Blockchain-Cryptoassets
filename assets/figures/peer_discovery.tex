...
\begin{tikzpicture}[scale = 0.8]
	...
	\uncover<3-3>{
		\node (agenta2) at (agenta) {\includegraphics[width = 0.6 cm, decodearray={0.8 0 0.5 0 0.5 0}]{../assets/images/agents/avatar_rand3}};
		\node (agentf2) at (agentf) {\includegraphics[width = 0.6 cm, decodearray={0.8 0 0.5 0 0.5 0}]{../assets/images/agents/avatar_rand3}};	
		\node (agentg2) at (agentg) {\includegraphics[width = 0.6 cm, decodearray={0.8 0 0.5 0 0.5 0}]{../assets/images/agents/avatar_rand4}};		
