...
% Payee
	\node 			(payee) at (11.25,-1.51) {\includegraphics[height = 1.2cm]{../assets/images/avatar_left.png}};

% Payer
	\node 			(payer) at (-1.75,-1.51) {\includegraphics[height = 1.2cm]{../assets/images/avatar_right.png}};
