...
\only<1-5>{
\draw[color=black] plot (2,1.3)   node[minimum width=2.7cm,fill=highlight!15, thick,  draw=highlight,below, rotate = 0] {\texttt{<sig 2>}};
}

\only<1-5>{
\draw[color=black] plot (2,2)   node[minimum width=2.7cm, fill=highlight!15, thick,  draw=highlight,below, rotate = 0] {\texttt{<sig 3>}};
}
...
\only<9,10>{
\draw[color=black] plot (2,2)   node[minimum width=2.7cm,fill=black!15, thick,  draw=black,below, rotate = 0] {\texttt{<sig 2>}};
}

\only<6-9>{
\draw[color=black] plot (2,2.7)   node[minimum width=2.7cm, fill=highlight!15, thick,  draw=highlight,below, rotate = 0] {\texttt{<sig 3>}};
}

\only<10>{
\draw[color=black] plot (2,2.7)   node[minimum width=2.7cm, fill=black!15, thick,  draw=black,below, rotate = 0] {\texttt{<sig 3>}};
}
