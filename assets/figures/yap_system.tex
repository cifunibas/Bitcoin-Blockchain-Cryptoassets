...
% Payee
	\node 			(payee) at (12,7) {\includegraphics[height = 1.6cm]{../assets/images/avatar_left.png}};

% Payer
	\node 			(payer) at (0,7) {\includegraphics[height = 1.6cm]{../assets/images/avatar_right.png}};
...
% Network
	\node			(agenta) at (1,2.8) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand3.png}};
	\node 			(agentb) at (0.5,1) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand4.png}};
	\node 			(agentc) at (3,2.1) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand5.png}};
	\node 			(agentd) at (2.8,0) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand1.png}};
	\node 			(agente) at (5,4.3) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand2.png}};	
	\node 			(agentf) at (5.1,1.1) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand3.png}};
	\node 			(agentg) at (7.5,3.8) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand4.png}};
	\node 			(agenth) at (6.7,0.4) {\includegraphics[width = 0.6 cm]{../assets/images/avatar_rand5.png}};	
