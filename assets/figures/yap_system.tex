...
% Payee
	\node 			(payee) at (12,7) {\includegraphics[width = 1 cm]{../assets/images/avatar.png}};

% Payer
	\node 			(payer) at (0,7) {\includegraphics[width = 1 cm]{../assets/images/avatar.png}};
...
% Network
	\node			(agenta) at (1,2.8) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};
	\node 			(agentb) at (0.5,1) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};
	\node 			(agentc) at (3,2.1) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};
	\node 			(agentd) at (2.8,0) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};
	\node 			(agente) at (5,4.3) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};	
	\node 			(agentf) at (5.1,1.1) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};
	\node 			(agentg) at (7.5,3.8) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};
	\node 			(agenth) at (6.7,0.4) {\includegraphics[width = 0.6 cm]{../assets/images/avatar.png}};	
	

% Goods vs. Money flow
	
	\draw[->, thick, dashed]	([yshift=0.5cm]payer.south east) -- ([yshift=0.5cm]payee.south west) node[midway, fill=white] {Stone Property Rights};
