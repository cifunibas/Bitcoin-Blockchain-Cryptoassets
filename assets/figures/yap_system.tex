...
% Goods vs. Money flow
	...
	\uncover<3->{\draw[->, thick, dashed]	([yshift=1cm]payer.south east) -- ([yshift=1cm]payee.south west) node[midway, fill=white] {Stone Property Rights};}
	
	\uncover<4->{\draw[->, thick, dashed]	(payer.south) -- (agenta.north) node[midway, fill=white, align = center, text = focus] {\footnotesize "Payee is new owner\\ \footnotesize of stone XY"};}
